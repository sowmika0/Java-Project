...
<%  String strErrMsg = null;
	if(session.getAttribute("LDAPERRMSG")==null){
		...
		strErrMsg = (String)session.getAttribute("LDAPERRMSG");
		session.setAttribute("LDAPERRMSG",null);
	}
%>
...
<table id="container">
	<tbody>
		<tr>
			<td nowrap width="50%">
			<form name="login" method="post" action="<%=request.getContextPath()%>/servlet/BrowserServlet">

...
<%
	...
	String delimiter = LoginServlet.mwConfig.getConfigValue(AuthenticationServerConfiguration.MEM_WORD_SEED_DELIM);
	...
	char[] allowedCharacters = new LoginServlet().getAllowedCharacters();
%>

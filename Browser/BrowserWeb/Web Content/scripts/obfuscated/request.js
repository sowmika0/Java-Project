...
function createResultWindow2(cmdname, width, height, page)
{
	...
	if ( ( compScreen != "" ) && ( cmdname != "0b}K0}56" ) && ( prefix != "0b1yy" ) && ( breadcrumbAction !="8teP" )&& (enquiryType != "e}6hYqhCY6lo1ba") && (requestRoutineName != "OS.GET.PASSBOOK.PRINT.DATA"))
	{
	...
	if (enquiryType == "e}6hYqhCY6lo1ba") 
	{
	...
	if (breadcrumbAction == "8teP" && compScreen != ""  )
 	{
	...
	if ( compTarget && compTarget != "NEW" )
	{
		...
		else
		{
			...
			if (!top.noFrames && FragmentUtil.isCompositeScreen() && prefix != "0b1yy")
		 	{
